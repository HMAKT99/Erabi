    ...
    (e.modules = {
      ...
      2403: (e, t, s) => {
        ...
        let c = [
                  ...
                  children: [
                    "[id]",
                    {
                      children: [
                        ...
                        {
                          page: [
                            () => Promise.resolve().then(s.bind(s, 1683)),
            ...
            {
              layout: [
                () => Promise.resolve().then(s.bind(s, 5783)),
      ...
      7733: (e, t, s) => {
        Promise.resolve().then(s.bind(s, 6037));
      },
      3766: (e, t, s) => {
        (Promise.resolve().then(s.bind(s, 4334)), Promise.resolve().then(s.t.bind(s, 307, 23)));
      },
      2785: (e, t, s) => {
                      ...
                      children: [
                        ...
                        (0, a.jsxs)("dl", {
                          ...
                          children: [
                            a.jsx(d, {
                              label: "capabilities",
                              value: t.manifest.capabilities.join(", "),
                            }),
                            a.jsx(d, { label: "owner", value: t.manifest.owner.type }),
                            a.jsx(d, {
                              label: "payout binding",
                              value: t.manifest.owner.payout_binding ? "bound" : "unbound",
                            }),
                            a.jsx(d, {
                              label: "accepts sponsored",
                              value: String(t.manifest.policy.accepts_sponsored),
                            }),
                            a.jsx(d, { label: "key seq", value: String(t.key_seq) }),
                            a.jsx(d, { label: "joined", value: t.created_at.slice(0, 10) }),
                            a.jsx(d, { label: "referrer", value: t.manifest.referrer ?? "—" }),
                          ],
                        }),
                        a.jsx("img", {
                              ...
                              ? (0, a.jsxs)(a.Fragment, {
                                  children: [
                                    ...
                                    a.jsx("dl", {
                                      ...
                                      children: Object.entries(i.components).map(([e, t]) =>
                                        (0, a.jsxs)(
                                          "div",
                                          {
        ...
        function d({ label: e, value: t }) {
          return (0, a.jsxs)("div", {
            children: [
              ...
              a.jsx("dd", { className: "mt-0.5 break-all", children: t }),
            ],
          });
        }
      ...
      4334: (e, t, s) => {
        ...
        function l() {
          ...
          return a.jsx("button", {
            onClick: function () {
              let s = "dark" === e ? "light" : "dark";
              (t(s),
                localStorage.setItem("erabi.theme", s),
                document.documentElement.classList.toggle("light", "light" === s));
            },
      ...
      1683: (e, t, s) => {
        ...
        let a = (0, s(1924).createProxy)(
          String.raw`/Users/arun/erabi/apps/explorer/app/agents/[id]/page.tsx#default`,
        );
      },
      5783: (e, t, s) => {
        "use strict";
        (s.r(t), s.d(t, { default: () => i, metadata: () => n }));
        var a = s(9222),
          r = s(3023);
        let l = (0, s(1924).createProxy)(
