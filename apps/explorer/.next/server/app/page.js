(() => {
  ...
  ((e.id = 931),
    ...
    (e.modules = {
        ...
        let d = [
            "",
            {
              children: [
                ...
                {
                  page: [
                    () => Promise.resolve().then(r.bind(r, 86)),
      ...
      8417: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 9255));
      },
      2785: (e, t, r) => {
            ...
            (0, s.jsxs)("main", {
              ...
              children: [
                (0, s.jsxs)("section", {
                  ...
                  children: [
                    s.jsx(o, { label: "agents", value: e?.agents }),
                    s.jsx(o, { label: "intents", value: r?.intents }),
                    s.jsx(o, { label: "sponsored served", value: r?.sponsored_served }),
                    s.jsx(o, {
                      label: "settled (usd)",
                ...
                (0, s.jsxs)("section", {
                  ...
                  children: [
                    (0, s.jsxs)("div", {
                      className: "panel",
                      children: [
                        s.jsx("h2", { className: "label mb-3", children: "live network feed" }),
                        (0, s.jsxs)("div", {
                    ...
                    (0, s.jsxs)("div", {
                      ...
                      children: [
                        ...
                        (0, s.jsxs)("div", {
                          className: "panel",
                          children: [
                            s.jsx("h2", { className: "label mb-3", children: "agent lookup" }),
                            (0, s.jsxs)("form", {
                              onSubmit: (e) => {
                                (e.preventDefault(),
                                  h.trim() &&
                                    (window.location.href = `/agents/${encodeURIComponent(h.trim())}`));
                              },
                              className: "flex gap-2",
                              children: [
                                s.jsx("input", {
        ...
        function o({ label: e, value: t }) {
          return (0, s.jsxs)("div", {
            ...
            children: [
              ...
              s.jsx("div", { className: "mt-1 text-2xl text-terminal-green", children: t ?? "—" }),
            ],
          });
        }
      },
