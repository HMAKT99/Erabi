  ...
  ((e.id = 931),
    ...
    (e.modules = {
        ...
        let d = [
              ...
              children: [
                ...
                {},
                {
                  page: [
                    ...
                    "/Users/arun/erabi/apps/landing/app/page.tsx",
                  ],
                },
              ],
            },
            {
              layout: [
                ...
                "/Users/arun/erabi/apps/landing/app/layout.tsx",
              ],
              "not-found": [
          ...
          c = ["/Users/arun/erabi/apps/landing/app/page.tsx"],
          m = "/page",
      ...
      9255: (e, t, s) => {
        ...
        var n = s(2064),
          a = s(5032);
        let r = process.env.NEXT_PUBLIC_ERABI_EXPLORER_URL ?? "http://localhost:4100";
        (process.env.NEXT_PUBLIC_ERABI_REGISTRY_URL, process.env.NEXT_PUBLIC_ERABI_EXCHANGE_URL);
        let i = process.env.NEXT_PUBLIC_ERABI_ATTRIBUTION_URL ?? "http://localhost:4003",
          l = `import { Erabi } from "@erabi/sdk";
...
// later: await choices.report(providerId, "task_success");`;
          ...
          return (0, n.jsxs)("main", {
            ...
            children: [
                ...
                children: [
                  ...
                  (0, n.jsxs)("p", {
                    children: [
                      ...
                      " ",
                      n.jsx("b", { children: "signed, labeled, and inspectable" }),
              ...
              (0, n.jsxs)("section", {
                ...
                children: [
                  n.jsx(d, { label: "agents", value: e.agents }),
                  n.jsx(d, { label: "intents cleared", value: e.intents }),
                  n.jsx(d, {
                    label: "settled",
                    value: void 0 !== e.settled ? `$${e.settled.toFixed(2)}` : void 0,
                  }),
                ],
              }),
              (0, n.jsxs)("p", {
              ...
              (0, n.jsxs)("section", {
                className: "mt-12",
                children: [
                  n.jsx("h2", { className: "label mb-2", children: "join in three lines" }),
                  n.jsx("pre", {
                    className: "panel overflow-x-auto text-xs leading-relaxed",
                    children: n.jsx("code", { children: l }),
                  }),
                  (0, n.jsxs)("p", {
              ...
              (0, n.jsxs)("section", {
                ...
                children: [
                  (0, n.jsxs)("a", {
                    href: "https://github.com/erabi-protocol",
                    className: "panel hover:border-terminal-green",
                    children: [
                      n.jsx("div", { className: "text-terminal-green", children: "github →" }),
                      n.jsx("div", {
                  ...
                  (0, n.jsxs)("a", {
                    ...
                    className: "panel hover:border-terminal-green",
                    children: [
                      n.jsx("div", { className: "text-terminal-green", children: "explorer →" }),
                      n.jsx("div", {
                        className: "mt-1 text-xs text-terminal-dim",
        ...
        function d({ label: e, value: t }) {
          return (0, n.jsxs)("div", {
            className: "panel",
            children: [
              n.jsx("div", { className: "text-2xl text-terminal-green", children: t ?? "—" }),
              n.jsx("div", { className: "label mt-1", children: e }),
            ],
          });
        }
      },
      1595: (e, t, s) => {
        "use strict";
        (s.r(t), s.d(t, { default: () => r, metadata: () => a }));
        var n = s(9222);
        s(6557);
        let a = {
        ...
        function r({ children: e }) {
          return n.jsx("html", { lang: "en", children: n.jsx("body", { children: e }) });
        }
      },
      86: (e, t, s) => {
        "use strict";
        (s.r(t), s.d(t, { default: () => n }));
        let n = (0, s(1924).createProxy)(
          String.raw`/Users/arun/erabi/apps/landing/app/page.tsx#default`,
        );
      },
      6557: () => {},
    }));
