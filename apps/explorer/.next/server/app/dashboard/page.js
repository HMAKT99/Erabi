    ...
    (e.modules = {
      ...
      6421: (e, t, a) => {
        ...
        let o = [
              ...
              children: [
                "dashboard",
                {
                  children: [
                    ...
                    {
                      page: [
                        () => Promise.resolve().then(a.bind(a, 7283)),
            ...
            {
              layout: [
                () => Promise.resolve().then(a.bind(a, 5783)),
                "/Users/arun/erabi/apps/explorer/app/layout.tsx",
              ],
              "not-found": [
                () => Promise.resolve().then(a.t.bind(a, 8714, 23)),
      ...
      673: (e, t, a) => {
        Promise.resolve().then(a.bind(a, 1541));
      },
      3766: (e, t, a) => {
        (Promise.resolve().then(a.bind(a, 4334)), Promise.resolve().then(a.t.bind(a, 307, 23)));
      },
      2785: (e, t, a) => {
        (Promise.resolve().then(a.t.bind(a, 417, 23)),
          Promise.resolve().then(a.t.bind(a, 181, 23)),
          Promise.resolve().then(a.t.bind(a, 7814, 23)),
          Promise.resolve().then(a.t.bind(a, 5266, 23)),
          Promise.resolve().then(a.t.bind(a, 490, 23)),
          Promise.resolve().then(a.t.bind(a, 2648, 23)));
      },
      1541: (e, t, a) => {
        "use strict";
        ...
        function n() {
          let [e, t] = (0, s.useState)([]),
            ...
            x = d.reduce(
              (e, t) => ({
                accrued: e.accrued + (t.earnings?.accrued_usd ?? 0),
                available: e.available + (t.earnings?.available_usd ?? 0),
                paid: e.paid + (t.earnings?.paid_usd ?? 0),
              }),
          ...
          return (0, r.jsxs)("main", {
            ...
            children: [
              (0, r.jsxs)("section", {
                className: "panel",
                children: [
                  r.jsx("h1", { className: "label mb-2", children: "owner dashboard" }),
                  r.jsx("p", {
              ...
              d.length > 0 &&
                (0, r.jsxs)("section", {
                  ...
                  children: [
                    r.jsx(l, { label: "accrued", value: `$${x.accrued.toFixed(4)}` }),
                    r.jsx(l, { label: "available", value: `$${x.available.toFixed(4)}` }),
                    r.jsx(l, { label: "paid out", value: `$${x.paid.toFixed(4)}` }),
                  ],
                }),
              d.map((a) =>
                (0, r.jsxs)(
                    ...
                    children: [
                        ...
                        children: [
                          ...
                          (0, r.jsxs)("div", {
                            ...
                            children: [
                              ...
                              (0, r.jsxs)("span", { children: ["rep ", a.reputation] }),
                              r.jsx("button", {
                                onClick: () => t(e.filter((e) => e !== a.id)),
                      ...
                      (0, r.jsxs)("dl", {
                        ...
                        children: [
                          r.jsx(i, {
                            label: "accrued",
                            value: `$${(a.earnings?.accrued_usd ?? 0).toFixed(4)}`,
                          }),
                          r.jsx(i, {
                            label: "available",
                            value: `$${(a.earnings?.available_usd ?? 0).toFixed(4)}`,
                          }),
                          r.jsx(i, {
                            label: "paid",
                            value: `$${(a.earnings?.paid_usd ?? 0).toFixed(4)}`,
                          }),
                          r.jsx(i, {
                            label: "payout",
                            value: a.payoutBound ? "bound" : "unbound",
                            warn: !a.payoutBound,
                          }),
                          r.jsx(i, {
                            label: "disputes / frozen",
                            value: `${a.disputes} / ${a.frozenEvents}`,
                            warn: a.disputes + a.frozenEvents > 0,
                          }),
                          r.jsx(i, {
                            label: "ledger",
                            value: !1 === a.chainValid ? "CHAIN BROKEN" : "verified",
                            warn: !1 === a.chainValid,
                          }),
                        ],
                      }),
        ...
        function l({ label: e, value: t }) {
          return (0, r.jsxs)("div", {
            ...
            children: [
              r.jsx("div", { className: "text-xl text-terminal-green", children: t }),
              r.jsx("div", { className: "label mt-1", children: e }),
            ],
          });
        }
        function i({ label: e, value: t, warn: a }) {
          return (0, r.jsxs)("div", {
            children: [
              r.jsx("dt", { className: "label", children: e }),
              r.jsx("dd", { className: `mt-0.5 ${a ? "text-terminal-amber" : ""}`, children: t }),
            ],
          });
        }
        a(2856);
      ...
      4334: (e, t, a) => {
        ...
        function n() {
          ...
          return r.jsx("button", {
            onClick: function () {
              let a = "dark" === e ? "light" : "dark";
              (t(a),
                localStorage.setItem("erabi.theme", a),
                document.documentElement.classList.toggle("light", "light" === a));
            },
      ...
      7283: (e, t, a) => {
        ...
        let r = (0, a(1924).createProxy)(
          String.raw`/Users/arun/erabi/apps/explorer/app/dashboard/page.tsx#default`,
        );
      },
      5783: (e, t, a) => {
        "use strict";
        (a.r(t), a.d(t, { default: () => i, metadata: () => l }));
        var r = a(9222),
          s = a(3023);
        let n = (0, a(1924).createProxy)(
