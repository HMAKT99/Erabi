    ...
    (e.modules = {
      ...
      2790: (e, t, r) => {
        ...
        let d = [
              ...
              children: [
                "agents",
                {
                  children: [
                    ...
                    {
                      page: [
                        () => Promise.resolve().then(r.bind(r, 5195)),
          ...
          c = ["/Users/arun/erabi/apps/explorer/app/agents/page.tsx"],
          m = "/agents/page",
          ...
          let [e, t] = (0, a.useState)([]),
            ...
            m = (0, a.useMemo)(() => {
              ...
              return e
                .filter(
                  (e) =>
                    (!i || e.manifest.capabilities.includes(i)) &&
                    (!t ||
            ...
            x = Math.max(1, Math.ceil(m.length / 25)),
            h = m.slice(25 * o, (o + 1) * 25);
          return (0, s.jsxs)("main", {
            ...
            children: [
              (0, s.jsxs)("section", {
                ...
                children: [
                  s.jsx("h1", { className: "label mr-2", children: "agent directory" }),
                  s.jsx("input", {
                    value: r,
                    onChange: (e) => {
                  ...
                  (0, s.jsxs)("select", {
                    ...
                    children: [
                      s.jsx("option", { value: "", children: "all capabilities" }),
                      c.map((e) => s.jsx("option", { value: e, children: e }, e)),
                    ],
                  }),
                  (0, s.jsxs)("span", {
                    className: "text-xs text-terminal-dim",
                    children: [m.length, " agents"],
                  }),
                ],
              }),
              (0, s.jsxs)("section", {
                    ...
                    children: [
                      s.jsx("thead", {
                        ...
                        children: (0, s.jsxs)("tr", {
                          children: [
                            s.jsx("th", { className: "py-1", children: "agent" }),
                            s.jsx("th", { children: "capabilities" }),
                            s.jsx("th", { className: "text-right", children: "reputation" }),
                            s.jsx("th", { className: "text-right", children: "tier" }),
                            s.jsx("th", { className: "text-right", children: "joined" }),
                          ],
                        }),
                      }),
                      s.jsx("tbody", {
      ...
      5195: (e, t, r) => {
        ...
        let s = (0, r(1924).createProxy)(
          String.raw`/Users/arun/erabi/apps/explorer/app/agents/page.tsx#default`,
        );
      },
      5783: (e, t, r) => {
        "use strict";
